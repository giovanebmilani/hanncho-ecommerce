...
const Home: React.FC = () => {
	...
	const {
		...
		isRefetching: isHighlightedRefreching,
	...
	const isHighlightedPlaceholder = isHighlightedLoading && !isHighlightedRefreching

	const isSalePlaceholder = isSaleLoading && !isSaleRefreching
			...
			<div className='products-container'>
				...
				<div ref={highlightedProductsSliderRef} className='product-slider'>
					{isHighlightedPlaceholder ? (
						...
						highlightedProducts.map((prod, index) => <ProductCard key={index} product={prod} />)
					)}
			...
			<div className='products-container'>
				...
				<div className='product-slider' ref={saleProductsSliderRef}>
					{isSalePlaceholder ? (
						...
						saleProducts.map((prod, index) => <ProductCard key={index} product={prod} />)
					)}
